	...
	for idx, msg := range msgs {
		...
		for _, block := range msg.ContentBlocks {
			if block.StreamingMeta == nil {
				...
				blocksList = expandSlice(block.StreamingMeta.Index, blocksList)
				blocksList[block.StreamingMeta.Index] = append(blocksList[block.StreamingMeta.Index], block)
			}
		}
...
func concatContentBlockHelper[T contentBlockVariant](
	...
	block.StreamingMeta = &StreamingMeta{
		Index: blocks[0].StreamingMeta.Index,
	}
	block.Extra = extra
