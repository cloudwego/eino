...
const (
	Partial ConcatMode = "partial"
	Full    ConcatMode = "full"
)
...
type MessageOutputImage struct {
	MessagePartCommon
	ConcatMode ConcatMode `json:"concat_mode,omitempty"`
}
...
// Deprecated: ChatMessageImageURL is used to represent an image part in a chat message.
...
// Deprecated: ChatMessageAudioURL is used to represent an audio part in a chat message.
// Choose either URL or URI.
...
// Deprecated: ChatMessageVideoURL is used to represent an video part in a chat message.
// Choose either URL or URI.
...
// Deprecated: ChatMessageFileURL is used to represent an file part in a chat message.
// Choose either URL or URI.
...
// Deprecated: ChatMessagePart is the part in a chat message.
