...
// MessageOutputToolCall represents a tool call generated by the model.
// It is used in MessageOutputPart when Type is ChatMessagePartTypeToolCall.
type MessageOutputToolCall struct {
...
type MessageOutputPart struct {
	...
	// ToolCall contains the tool call generated by the model.
	// Used when Type is ChatMessagePartTypeToolCall.
	ToolCall *MessageOutputToolCall `json:"tool,omitempty"`
...
const (
	...
	// ChatMessagePartTypeToolCall means the part is a tool call generated by the model.
	ChatMessagePartTypeToolCall ChatMessagePartType = "tool_call"
)
