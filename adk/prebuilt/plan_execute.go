...
// PlanParser parses the plan string generated by Model into a Plan instance.
...
type PlannerConfig struct {
	...
	// PlanParser parses the model-generated plan string into a Plan instance.
	// The arguments format of PlanParser depends on the model configuration:
	//   - ChatModelWithFormattedOutput: expects Plan format output
	//   - ToolCallingChatModel + ToolInfo: uses ToolInfo schema for arguments structure
	// if not provided，defaultPlanParserFn will be used as the default.
...
type ReplannerConfig struct {
	...
	// PlanParser parses the model-generated plan string into a Plan instance.
	// The arguments format of PlanParser depends on the model configuration:
	//   - ChatModel with PlanTool: uses PlanTool schema for arguments structure
	// If not provided, defaultPlanParserFn will be used as the default.
	PlanParser PlanParser
}
