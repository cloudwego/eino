...
func newTestTurnLoop() *adk.TurnLoop[TurnInput, adk.Message] {
	return adk.NewTurnLoop(adk.TurnLoopConfig[TurnInput, adk.Message]{
		...
		PrepareAgent: func(ctx context.Context, loop *adk.TurnLoop[TurnInput, adk.Message], items []TurnInput) (adk.Agent, error) {
