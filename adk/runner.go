...
func (r *TypedRunner[M]) resumeInternal(ctx context.Context, checkPointID string, resumeData map[string]any,
	...
	return typedRunnerResumeInternalImpl(r.a, r.enableStreaming, r.store, r.sessionID, r.sessionStore, r.sessionPersist, ctx, checkPointID, resumeData, opts...)
}
...
func typedRunnerResumeInternalImpl[M MessageType](a TypedAgent[M], enableStreaming bool, store CheckPointStore, sessionID string, sessionStore SessionStore, sessionPersistence *SessionPersistenceConfig, ctx context.Context, checkPointID string, resumeData map[string]any, //nolint:revive // argument-limit
	opts ...AgentRunOption) (*AsyncIterator[*TypedAgentEvent[M]], error) {
	if store == nil {
