...
func (h *testInstructionHandler) BeforeAgent(ctx context.Context, runCtx *TypedChatModelAgentContext[*schema.Message]) (context.Context, *TypedChatModelAgentContext[*schema.Message], error) {
...
func (h *testInstructionFuncHandler) BeforeAgent(ctx context.Context, runCtx *TypedChatModelAgentContext[*schema.Message]) (context.Context, *TypedChatModelAgentContext[*schema.Message], error) {
...
func (h *testToolsHandler) BeforeAgent(ctx context.Context, runCtx *TypedChatModelAgentContext[*schema.Message]) (context.Context, *TypedChatModelAgentContext[*schema.Message], error) {
...
func (h *testToolsFuncHandler) BeforeAgent(ctx context.Context, runCtx *TypedChatModelAgentContext[*schema.Message]) (context.Context, *TypedChatModelAgentContext[*schema.Message], error) {
...
type testBeforeAgentHandler struct {
	*BaseChatModelAgentMiddleware
	fn func(ctx context.Context, runCtx *TypedChatModelAgentContext[*schema.Message]) (context.Context, *TypedChatModelAgentContext[*schema.Message], error)
}

func (h *testBeforeAgentHandler) BeforeAgent(ctx context.Context, runCtx *TypedChatModelAgentContext[*schema.Message]) (context.Context, *TypedChatModelAgentContext[*schema.Message], error) {
...
func (h *countingHandler) BeforeAgent(ctx context.Context, runCtx *TypedChatModelAgentContext[*schema.Message]) (context.Context, *TypedChatModelAgentContext[*schema.Message], error) {
	h.mu.Lock()
	h.beforeAgentCount++
	h.mu.Unlock()
	return ctx, runCtx, nil
