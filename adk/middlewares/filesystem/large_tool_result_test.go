...
func (m *mockBackend) Write(ctx context.Context, filePath, content string) error {
	m.files[filePath] = content
	return nil
}

func (m *mockBackend) Read(ctx context.Context, filePath string, offset, limit int) (string, error) {
...
func (m *mockBackend) LsInfo(ctx context.Context, path string) ([]FileInfo, error) {
	return nil, nil
}

func (m *mockBackend) GrepRaw(ctx context.Context, pattern string, path, glob *string) ([]GrepMatch, error) {
	return nil, nil
}

func (m *mockBackend) GlobInfo(ctx context.Context, pattern, path string) ([]FileInfo, error) {
	return nil, nil
}

func (m *mockBackend) Edit(ctx context.Context, filePath, oldString, newString string, replaceAll bool) error {
	return nil
}
...
func (f *failingBackend) Write(ctx context.Context, filePath, content string) error {
	if f.writeErr != nil {
		return f.writeErr
	}
	return nil
...
func (f *failingBackend) Read(ctx context.Context, filePath string, offset, limit int) (string, error) {
	return "", nil
}

func (f *failingBackend) LsInfo(ctx context.Context, path string) ([]FileInfo, error) {
	return nil, nil
}

func (f *failingBackend) GrepRaw(ctx context.Context, pattern string, path, glob *string) ([]GrepMatch, error) {
	return nil, nil
}

func (f *failingBackend) GlobInfo(ctx context.Context, pattern, path string) ([]FileInfo, error) {
	return nil, nil
}

func (f *failingBackend) Edit(ctx context.Context, filePath, oldString, newString string, replaceAll bool) error {
	return nil
}
