...
func TestLoader_NoImportsPassthrough(t *testing.T) {
	...
	l := newLoader(b, []string{"/agent.md"}, 0, false)
...
func TestLoader_ImportAsSeparateSection(t *testing.T) {
	...
	l := newLoader(b, []string{"/doc.md"}, 0, false)
	content, err := l.load(context.Background())
	if err != nil {
		t.Fatal(err)
	}
...
func TestLoader_RelativePathResolution(t *testing.T) {
	...
	l := newLoader(b, []string{"/a/b/host.md"}, 0, false)
	content, err := l.load(context.Background())
	if err != nil {
		t.Fatal(err)
	}
...
func TestLoader_NestedRelativeImport(t *testing.T) {
	...
	l := newLoader(b, []string{"/root/main.md"}, 0, false)
	content, err := l.load(context.Background())
	if err != nil {
		t.Fatal(err)
	}
...
func TestLoader_TransitiveImport(t *testing.T) {
	...
	l := newLoader(b, []string{"/main.md"}, 0, false)
	content, err := l.load(context.Background())
	if err != nil {
		t.Fatal(err)
	}
...
func TestLoader_EmptyFile(t *testing.T) {
	...
	l := newLoader(b, []string{"/empty.md"}, 0, false)
	content, err := l.load(context.Background())
	if err != nil {
		t.Fatal(err)
	}
...
func TestLoader_MaxBytesFirstFileFull(t *testing.T) {
	...
	l := newLoader(b, []string{"/big.md"}, 3, false)
...
func TestLoader_CircularImportInline(t *testing.T) {
	...
	l := newLoader(b, []string{"/a.md"}, 0, false)
	content, err := l.load(context.Background())
	if err != nil {
		t.Fatalf("expected no error (circular import is logged), got %v", err)
	}
...
func TestLoader_MaxDepthInline(t *testing.T) {
	...
	l := newLoader(b, []string{"/level0.md"}, 0, false)
	content, err := l.load(context.Background())
	if err != nil {
		t.Fatalf("expected no error (depth exceeded is logged), got %v", err)
	}
...
func TestLoader_MaxBytesWithImports(t *testing.T) {
	...
	l := newLoader(b, []string{"/a.md", "/b.md"}, 120, false)
...
func TestMiddleware_GenerateError(t *testing.T) {
	...
	ctx := context.Background()
	mw, err := New(ctx, &Config{Backend: b, AgentsMDFiles: []string{"/missing.md"}})
	if err != nil {
		t.Fatal(err)
	}
...
func TestLoader_DuplicateTopLevelFiles(t *testing.T) {
	...
	l := newLoader(b, []string{"/agent.md", "/agent.md"}, 0, false)
	content, err := l.load(context.Background())
	if err != nil {
		t.Fatal(err)
	}
...
func TestLoader_LoadFileError(t *testing.T) {
	...
	l := newLoader(b, []string{"/missing.md"}, 0, false)
...
func TestLoader_MaxBytesStopsImports(t *testing.T) {
	...
	l := newLoader(b, []string{"/main.md"}, 50, false)
	content, err := l.load(context.Background())
	if err != nil {
		t.Fatal(err)
	}
...
func TestLoader_ExactOutput(t *testing.T) {
	...
	l := newLoader(b, []string{"/project/CLAUDE.md"}, 0, false)
	content, err := l.load(context.Background())
	if err != nil {
		t.Fatal(err)
	}
...
func TestLoader_IgnoreLoadFileError_MissingFile(t *testing.T) {
	b := newMemBackend()
	b.set("/good.md", "GOOD CONTENT")
	// /missing.md is not set

	l := newLoader(b, []string{"/missing.md", "/good.md"}, 0, true)
	content, err := l.load(context.Background())
	if err != nil {
		t.Fatalf("expected no error with ignoreErr=true, got %v", err)
	}
...
func TestLoader_IgnoreLoadFileError_AllMissing(t *testing.T) {
	b := newMemBackend()

	l := newLoader(b, []string{"/missing1.md", "/missing2.md"}, 0, true)
	content, err := l.load(context.Background())
	if err != nil {
		t.Fatalf("expected no error with ignoreErr=true, got %v", err)
	}
...
func TestLoader_IgnoreLoadFileError_CircularImport(t *testing.T) {
	b := newMemBackend()
	b.set("/a.md", "A content @/b.md")
	b.set("/b.md", "B content @/a.md")

	// With ignoreErr=false, circular import in loadFile returns error,
	// but collectImports already logs and skips. Test with ignoreErr=true
	// to ensure no panic or unexpected behavior.
	l := newLoader(b, []string{"/a.md"}, 0, true)
	content, err := l.load(context.Background())
	if err != nil {
...
func TestLoader_IgnoreLoadFileError_DepthExceeded(t *testing.T) {
	b := newMemBackend()
	...
	l := newLoader(b, []string{"/l0.md"}, 0, true)
	content, err := l.load(context.Background())
	if err != nil {
		t.Fatalf("expected no error with ignoreErr=true, got %v", err)
	}
...
func TestMiddleware_IgnoreLoadFileError_Generate(t *testing.T) {
	b := newMemBackend()
	...
	if err != nil {
		t.Fatalf("expected no error with IgnoreLoadFileError, got %v", err)
	}
...
func TestMiddleware_IgnoreLoadFileError_Stream(t *testing.T) {
	b := newMemBackend()
