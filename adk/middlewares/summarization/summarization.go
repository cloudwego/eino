...
type Config struct {
	...
	// Retry configures retry behavior for the model.Generate call during summarization.
	// When set, failed or unacceptable generate calls are retried.
...
type SummarizeResult struct {
	...
	// Err is the error from the summarization attempt. Nil on success.
	Err error
}

// ModelRetryConfig configures retry behavior for the summarization process.
