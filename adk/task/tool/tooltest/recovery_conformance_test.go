...
func conformanceConfig(
	tools []backgroundtool.RecoverableTool,
...
func healthyConformanceTools(stopErr error) []backgroundtool.RecoverableTool {
	newTool := func() backgroundtool.RecoverableTool {
	...
	return []backgroundtool.RecoverableTool{newTool(), newTool(), newTool()}
}
...
func TestCheckRecoveryConformance(t *testing.T) {
	...
	for _, config := range []*RecoveryConformanceConfig{
		...
		{},
		{
			...
			NewTool: func() backgroundtool.RecoverableTool { return nil },
			Snapshot: func(context.Context, string) (*RecoverySnapshot, error) {
				return nil, nil
			},
		},
...
func TestCheckRecoveryConformancePassesStableCheckpoint(t *testing.T) {
	...
	newStartingTool := func() backgroundtool.RecoverableTool {
		return &conformanceToolStub{
