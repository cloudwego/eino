...
func convTools(ctx context.Context, tools []tool.BaseTool, ms []InvokableToolMiddleware, sms []StreamableToolMiddleware,
	...
	for idx, bt := range tools {
		...
		if eit, ok = bt.(tool.EnhancedInvokableTool); ok {
			enhancedInvokable = wrapEnhancedInvokableToolCall(eit, ems, !meta.isComponentCallbackEnabled)
		}

		if est, ok = bt.(tool.EnhancedStreamableTool); ok {
			enhancedStreamable = wrapEnhancedStreamableToolCall(est, esms, !meta.isComponentCallbackEnabled)
		}

		if st == nil && it == nil && eit == nil && est == nil {
...
func wrapEnhancedInvokableToolCall(eit tool.EnhancedInvokableTool, middlewares []EnhancedInvokableToolMiddleware, needCallback bool) EnhancedInvokableToolEndpoint {
	...
	if needCallback {
		eit = &enhancedInvokableToolWithCallback{eit: eit}
	}
	return middleware(func(ctx context.Context, input *ToolInput) (*EnhancedInvokableToolOutput, error) {
		result, err := eit.InvokableRun(ctx, &tool.ToolCallInfo{TextArguments: input.Arguments}, input.CallOptions...)
		if err != nil {
			return nil, err
		}
...
func wrapEnhancedStreamableToolCall(est tool.EnhancedStreamableTool, middlewares []EnhancedStreamableToolMiddleware, needCallback bool) EnhancedStreamableToolEndpoint {
	...
	return middleware(func(ctx context.Context, input *ToolInput) (*EnhancedStreamableToolOutput, error) {
		result, err := est.StreamableRun(ctx, &tool.ToolCallInfo{TextArguments: input.Arguments}, input.CallOptions...)
		if err != nil {
			return nil, err
		}
...
func (e *enhancedInvokableToolWithCallback) Info(ctx context.Context) (*schema.ToolInfo, error) {
	return e.eit.Info(ctx)
}

func (e *enhancedInvokableToolWithCallback) InvokableRun(ctx context.Context, toolCallInfo *tool.ToolCallInfo, opts ...tool.Option) (*schema.ToolResult, error) {
	return invokeEnhancedWithCallbacks(e.eit.InvokableRun)(ctx, toolCallInfo, opts...)
}
...
func (e *enhancedStreamableToolWithCallback) StreamableRun(ctx context.Context, toolCallInfo *tool.ToolCallInfo, opts ...tool.Option) (*schema.StreamReader[*schema.ToolResult], error) {
...
func invokeEnhancedWithCallbacks(i func(ctx context.Context, toolCallInfo *tool.ToolCallInfo, opts ...tool.Option) (*schema.ToolResult, error)) func(ctx context.Context, toolCallInfo *tool.ToolCallInfo, opts ...tool.Option) (*schema.ToolResult, error) {
	return runWithCallbacks(i, onStart[*tool.ToolCallInfo], onEnd[*schema.ToolResult], onError)
}

func streamEnhancedWithCallbacks(s func(ctx context.Context, toolCallInfo *tool.ToolCallInfo, opts ...tool.Option) (*schema.StreamReader[*schema.ToolResult], error)) func(ctx context.Context, toolCallInfo *tool.ToolCallInfo, opts ...tool.Option) (*schema.StreamReader[*schema.ToolResult], error) {
	return runWithCallbacks(s, onStart[*tool.ToolCallInfo], onEndWithStreamOutput[*schema.ToolResult], onError)
}
